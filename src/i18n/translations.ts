...
const dict = {
  ...
  "tab.hotdeals": { ko: "핫딜", en: "Hot Deals" },
  "tab.community": { ko: "커뮤니티", en: "Community" },

  // Hot deals page
  "hotdeals.title": { ko: "오늘의 핫딜", en: "Today's Hot Deals" },
  "hotdeals.desc": {
    ko: "주요 커뮤니티 핫딜을 매일 자동 업데이트합니다",
    en: "Top community hot deals, updated daily",
  },
  "hotdeals.empty": { ko: "표시할 핫딜이 없습니다.", en: "No hot deals to show." },
  "hotdeals.loading": { ko: "불러오는 중...", en: "Loading..." },
  "hotdeals.source": { ko: "출처", en: "Source" },
  "hotdeals.viewOriginal": { ko: "원본 보기", en: "View original" },
  "hotdeals.share": { ko: "이 딜 공유", en: "Share this deal" },
  "hotdeals.copyLink": { ko: "링크 복사", en: "Copy link" },
  "hotdeals.linkCopied": { ko: "딜 링크가 복사되었어요", en: "Deal link copied" },
  "hotdeals.back": { ko: "← 목록으로", en: "← Back to deals" },
  "hotdeals.notFound": { ko: "딜을 찾을 수 없습니다.", en: "Deal not found." },
  "hotdeals.refresh": { ko: "새로고침", en: "Refresh" },
  "hotdeals.postedAt": { ko: "등록", en: "Posted" },
  "hotdeals.allCategories": { ko: "전체", en: "All" },
